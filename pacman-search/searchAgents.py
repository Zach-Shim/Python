        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if nextState in self.corners and nextState not in visited_corners:
                    visited_corners.append(nextState)
...
def cornersHeuristic(state, problem):
    ...
    while(len(unvisited_corners) > 0):
        distance, corner = min([(util.manhattanDistance(current_pos ,corner),corner) for corner in unvisited_corners])
